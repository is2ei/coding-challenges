...
//        // Overall complexity -> O(mn)
         ...
         */
//        Set<SinglyLinkedListNode> addresses = new HashSet<>();
//        while (head1 != null) { // O(n log n)
//            addresses.add(head1); // O(log n)
//            head1 = head1.next;
//        }
//
//        while (head2 != null) { // O(m log n)
//            if (addresses.contains(head2)) {
//                return head2.data;
//            }
//            head2 = head2.next;
//        }
